...
Let $$X$$ be the random variable for the random experiment of tossing a coin.  
Here, $$X$$ is a deterministic function that assigns a real-value to the outcome of an experiment of tossing a coin.
